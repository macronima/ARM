...
namespace IIS.arm
{
    ...
    public class склад : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.arm.Сотрудник fкладовщик;
        
        private IIS.arm.DetailArrayOfТоварНаСкладе fТоварНаСкладе;
        ...
        [NotNull()]
        public virtual IIS.arm.Сотрудник кладовщик
        {
            get
            {
                ...
                IIS.arm.Сотрудник result = this.fкладовщик;
        ...
        public virtual IIS.arm.DetailArrayOfТоварНаСкладе ТоварНаСкладе
        {
            get
            {
                ...
                {
                    this.fТоварНаСкладе = new IIS.arm.DetailArrayOfТоварНаСкладе(this);
                }
                IIS.arm.DetailArrayOfТоварНаСкладе result = this.fТоварНаСкладе;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View складE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("складE", typeof(IIS.arm.склад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View складL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("складL", typeof(IIS.arm.склад));
                }
            }
        }
    }
