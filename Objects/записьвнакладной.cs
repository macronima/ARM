...
namespace IIS.arm
{
    ...
    public class записьвнакладной : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.arm.накладная fнакладная;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.arm.накладная.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.arm.накладная накладная
        {
            get
            {
                ...
                IIS.arm.накладная result = this.fнакладная;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View записьвнакладнойE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("записьвнакладнойE", typeof(IIS.arm.записьвнакладной));
                }
            }
        }
    }
    ...
    public class DetailArrayOfзаписьвнакладной : ICSSoft.STORMNET.DetailArray
    {
        ...
        public IIS.arm.записьвнакладной this[int index]
        {
            get
            {
                return ((IIS.arm.записьвнакладной)(this.ItemByIndex(index)));
            }
        }
