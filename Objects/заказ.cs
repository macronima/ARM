...
namespace IIS.arm
{
    ...
    [View("заказL", new string[] {
            ...
            "датазаполнения as \'Датазаполнения\'",
            "менеджер.фамилия as \'Фамилия\'"})]
    public class заказ : IIS.arm.документ
    {
        
        private IIS.arm.состояниезаказа fстатус;
        ...
        private IIS.arm.Сотрудник fменеджер;
        
        private IIS.arm.DetailArrayOfСтрокаЗаказа fСтрокаЗаказа;
        ...
        public virtual IIS.arm.состояниезаказа статус
        {
            get
            {
                ...
                IIS.arm.состояниезаказа result = this.fстатус;
        ...
        [NotNull()]
        public virtual IIS.arm.Сотрудник менеджер
        {
            get
            {
                ...
                IIS.arm.Сотрудник result = this.fменеджер;
        ...
        public virtual IIS.arm.DetailArrayOfСтрокаЗаказа СтрокаЗаказа
        {
            get
            {
                ...
                {
                    this.fСтрокаЗаказа = new IIS.arm.DetailArrayOfСтрокаЗаказа(this);
                }
                IIS.arm.DetailArrayOfСтрокаЗаказа result = this.fСтрокаЗаказа;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View заказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("заказE", typeof(IIS.arm.заказ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View заказL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("заказL", typeof(IIS.arm.заказ));
                }
            }
        }
    }
