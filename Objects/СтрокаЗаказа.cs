...
namespace IIS.arm
{
    ...
    public class СтрокаЗаказа : ICSSoft.STORMNET.DataObject
    {
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.arm.заказ.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.arm.заказ заказ
        {
            get
            {
                ...
                IIS.arm.заказ result = this.fзаказ;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СтрокаЗаказаE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СтрокаЗаказаE", typeof(IIS.arm.СтрокаЗаказа));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСтрокаЗаказа : ICSSoft.STORMNET.DetailArray
    {
        ...
        public IIS.arm.СтрокаЗаказа this[int index]
        {
            get
            {
                return ((IIS.arm.СтрокаЗаказа)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.arm.СтрокаЗаказа dataobject)
        {
