    ...
    public class документ : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View документE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("документE", typeof(IIS.arm.документ));
                }
            }
            ...
            public static ICSSoft.STORMNET.View документL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("документL", typeof(IIS.arm.документ));
                }
            }
        }
    }
