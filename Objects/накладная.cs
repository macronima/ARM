...
namespace IIS.arm
{
    ...
    [View("накладнаяL", new string[] {
            ...
            "датазаполнения as \'Датазаполнения\'",
            "материальноОтветственноеЛицо.фамилия as \'Фамилия\'"})]
    public class накладная : IIS.arm.документ
    {
        
        private IIS.arm.состояниенакладной fстатус;
        ...
        private IIS.arm.Сотрудник fматериальноОтветственноеЛицо;
        
        private IIS.arm.DetailArrayOfзаписьвнакладной fзаписьвнакладной;
        ...
        public virtual IIS.arm.состояниенакладной статус
        {
            get
            {
                ...
                IIS.arm.состояниенакладной result = this.fстатус;
        ...
        [NotNull()]
        public virtual IIS.arm.Сотрудник материальноОтветственноеЛицо
        {
            get
            {
                ...
                IIS.arm.Сотрудник result = this.fматериальноОтветственноеЛицо;
        ...
        public virtual IIS.arm.DetailArrayOfзаписьвнакладной записьвнакладной
        {
            get
            {
                ...
                {
                    this.fзаписьвнакладной = new IIS.arm.DetailArrayOfзаписьвнакладной(this);
                }
                IIS.arm.DetailArrayOfзаписьвнакладной result = this.fзаписьвнакладной;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View накладнаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("накладнаяE", typeof(IIS.arm.накладная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View накладнаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("накладнаяL", typeof(IIS.arm.накладная));
                }
            }
        }
    }
