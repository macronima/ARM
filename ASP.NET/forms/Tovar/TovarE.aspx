...
<%@ Page Language="C#" MasterPageFile="~/Site1.Master"  AutoEventWireup="true" CodeBehind="TovarE.aspx.cs" Inherits="IIS.arm.ТоварE" %>
...
<div class="clearfix">
  <asp:Label CssClass="descLbl" ID="ctrlедицинаИзмеренияLabel" runat="server" Text="Едицина измерения" EnableViewState="False">
</asp:Label>
<asp:TextBox CssClass="descTxt" ID="ctrlедицинаИзмерения" runat="server">
</asp:TextBox>
