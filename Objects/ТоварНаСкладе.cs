...
namespace IIS.arm
{
    ...
    public class ТоварНаСкладе : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.arm.Товар fТовар;
        
        private IIS.arm.склад fсклад;
        ...
        [NotNull()]
        public virtual IIS.arm.Товар Товар
        {
            get
            {
                ...
                IIS.arm.Товар result = this.fТовар;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.arm.склад.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.arm.склад склад
        {
            get
            {
                ...
                IIS.arm.склад result = this.fсклад;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварНаСкладеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварНаСкладеE", typeof(IIS.arm.ТоварНаСкладе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТоварНаСкладе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.arm.DetailArrayOfТоварНаСкладе members)

        // *** End programmer edit section *** (IIS.arm.DetailArrayOfТоварНаСкладе members)
        ...
        /// </summary>
        public DetailArrayOfТоварНаСкладе(IIS.arm.склад fсклад) : 
                base(typeof(ТоварНаСкладе), ((ICSSoft.STORMNET.DataObject)(fсклад)))
        {
        }
        
        public IIS.arm.ТоварНаСкладе this[int index]
        {
            get
            {
                return ((IIS.arm.ТоварНаСкладе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.arm.ТоварНаСкладе dataobject)
        {
